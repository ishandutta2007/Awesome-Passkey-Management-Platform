...
<p align="center">
  ...
  <a href="https://github.com/ishandutta2007/Awesome-Passkey-Management-Platform/stargazers"><img src="https://img.shields.io/github/stars/ishandutta2007/Awesome-Passkey-Management-Platform?style=flat-square&color=gold" alt="GitHub_Stars" /></a>
...
| **Appwrite** | [![GitHub_Stars](https://img.shields.io/github/stars/appwrite/appwrite?style=social)](https://github.com/appwrite/appwrite/stargazers) | Open-source end-to-end backend server providing authentication, user management, OAuth, database, and functions. | TypeScript, Docker, PHP |
| **Keycloak** | [![GitHub_Stars](https://img.shields.io/github/stars/keycloak/keycloak?style=social)](https://github.com/keycloak/keycloak/stargazers) | Industry-standard open-source IAM supporting WebAuthn, passkeys, SSO, OIDC, SAML 2.0, LDAP, and enterprise federation. | Java, Quarkus |
| **Authelia** | [![GitHub_Stars](https://img.shields.io/github/stars/authelia/authelia?style=social)](https://github.com/authelia/authelia/stargazers) | Open-source single sign-on and two-factor authentication portal supporting WebAuthn passkeys, OIDC, and reverse proxy auth. | Go, TypeScript |
| **Authentik** | [![GitHub_Stars](https://img.shields.io/github/stars/goauthentik/authentik?style=social)](https://github.com/goauthentik/authentik/stargazers) | Open-source identity provider emphasizing modular flows, WebAuthn/FIDO2 MFA, SSO, OIDC, SAML, and Kubernetes readiness. | Python, Go |
| **Parse Server** | [![GitHub_Stars](https://img.shields.io/github/stars/parse-community/parse-server?style=social)](https://github.com/parse-community/parse-server/stargazers) | Open-source Node.js backend framework offering authentication, session management, and extensible user APIs. | Node.js, JavaScript |
| **Bitwarden Server** | [![GitHub_Stars](https://img.shields.io/github/stars/bitwarden/server?style=social)](https://github.com/bitwarden/server/stargazers) | Official open-source core backend for Bitwarden, enabling enterprise self-hosted credential vaults with passkey sync. | C#, .NET |
| **Ory Hydra** | [![GitHub_Stars](https://img.shields.io/github/stars/ory/hydra?style=social)](https://github.com/ory/hydra/stargazers) | Open-source OAuth 2.0 and OpenID Connect server designed for high-scale, cloud-native identity stacks. | Go |
| **SuperTokens** | [![GitHub_Stars](https://img.shields.io/github/stars/supertokens/supertokens-core?style=social)](https://github.com/supertokens/supertokens-core/stargazers) | Open-source developer authentication infrastructure providing passwordless, WebAuthn/passkey, sessions, and MFA. | Java, Node.js, Python |
| **ZITADEL** | [![GitHub_Stars](https://img.shields.io/github/stars/zitadel/zitadel?style=social)](https://github.com/zitadel/zitadel/stargazers) | Cloud-native open-source identity infrastructure with native FIDO2/WebAuthn passkeys, B2B multi-tenancy, OIDC, and SCIM. | Go |
| **Logto** | [![GitHub_Stars](https://img.shields.io/github/stars/logto-io/logto?style=social)](https://github.com/logto-io/logto/stargazers) | Open-source identity platform for SaaS products supporting passkeys, MFA, social sign-in, and multi-tenant organizations. | Node.js, TypeScript |
| **Casdoor** | [![GitHub_Stars](https://img.shields.io/github/stars/casdoor/casdoor?style=social)](https://github.com/casdoor/casdoor/stargazers) | UI-first open-source IAM platform supporting OAuth 2.0, OIDC, SAML, WebAuthn, social login, and multi-tenant management. | Go, React |
| **Ory Kratos** | [![GitHub_Stars](https://img.shields.io/github/stars/ory/kratos?style=social)](https://github.com/ory/kratos/stargazers) | Open-source cloud-native identity management system supporting WebAuthn passkeys, magic links, and customizable user flows. | Go |
| **Apereo CAS** | [![GitHub_Stars](https://img.shields.io/github/stars/apereo/cas?style=social)](https://github.com/apereo/cas/stargazers) | Enterprise open-source single sign-on server supporting WebAuthn, SAML, OIDC, OAuth, and legacy protocol integration. | Java, Spring Boot |
| **Hanko** | [![GitHub_Stars](https://img.shields.io/github/stars/teamhanko/hanko?style=social)](https://github.com/teamhanko/hanko/stargazers) | Modern open-source authentication system built ground-up for passkeys, WebAuthn, passkey-first UX, and self-hosting. | Go, TypeScript |
| **SpiceDB** | [![GitHub_Stars](https://img.shields.io/github/stars/authzed/spicedb?style=social)](https://github.com/authzed/spicedb/stargazers) | Open-source Zanzibar-inspired relationship-based access control (ReBAC) permission database. | Go |
| **Stack Auth** | [![GitHub_Stars](https://img.shields.io/github/stars/stack-auth/stack?style=social)](https://github.com/stack-auth/stack/stargazers) | Open-source developer auth platform providing Next.js / React authentication, passkey readiness, and user management. | TypeScript, Next.js |
| **Passbolt** | [![GitHub_Stars](https://img.shields.io/github/stars/passbolt/passbolt_api?style=social)](https://github.com/passbolt/passbolt_api/stargazers) | Open-source collaborative password and secret manager for teams, supporting self-hosting and GPG-encrypted sharing. | PHP, CakePHP |
| **Permify** | [![GitHub_Stars](https://img.shields.io/github/stars/Permify/permify?style=social)](https://github.com/Permify/permify/stargazers) | Open-source authorization service for building fine-grained relationship-based access control (ReBAC) system. | Go |
| **OpenFGA** | [![GitHub_Stars](https://img.shields.io/github/stars/openfga/openfga?style=social)](https://github.com/openfga/openfga/stargazers) | High-performance open-source Fine-Grained Authorization engine created by Okta and inspired by Google Zanzibar. | Go |
| **Ory Keto** | [![GitHub_Stars](https://img.shields.io/github/stars/ory/keto?style=social)](https://github.com/ory/keto/stargazers) | Open-source access control server implementing Google Zanzibar relationship-based access control (ReBAC). | Go |
| **Kanidm** | [![GitHub_Stars](https://img.shields.io/github/stars/kanidm/kanidm?style=social)](https://github.com/kanidm/kanidm/stargazers) | Modern open-source identity management server written in Rust with native WebAuthn/FIDO2 support and Linux integration. | Rust |
| **Cerbos** | [![GitHub_Stars](https://img.shields.io/github/stars/cerbos/cerbos?style=social)](https://github.com/cerbos/cerbos/stargazers) | Open-source policy-based authorization decision point enabling context-aware access policies. | Go |
| **Ory Oathkeeper** | [![GitHub_Stars](https://img.shields.io/github/stars/ory/oathkeeper?style=social)](https://github.com/ory/oathkeeper/stargazers) | Cloud-native open-source identity and access proxy for securing microservices and APIs. | Go |
| **Supabase Auth** | [![GitHub_Stars](https://img.shields.io/github/stars/supabase/auth?style=social)](https://github.com/supabase/auth/stargazers) | Open-source auth service powering Supabase, supporting JWT sessions, OAuth, magic links, and passwordless authentication. | Go |
...
| **Go-WebAuthn** | [![GitHub_Stars](https://img.shields.io/github/stars/go-webauthn/webauthn?style=social)](https://github.com/go-webauthn/webauthn/stargazers) | Popular Go library for WebAuthn (FIDO2) registration and authentication in custom web applications. | Go |
| **Py_WebAuthn** | [![GitHub_Stars](https://img.shields.io/github/stars/duo-labs/py_webauthn?style=social)](https://github.com/duo-labs/py_webauthn/stargazers) | Python WebAuthn server library developed by Duo Labs for implementing FIDO2 passkey verification. | Python |
| **WSO2 Identity Server** | [![GitHub_Stars](https://img.shields.io/github/stars/wso2/product-is?style=social)](https://github.com/wso2/product-is/stargazers) | Open-source enterprise identity and access management platform supporting SSO, federation, OIDC, SAML, and WebAuthn. | Java |
| **WebAuthn-rs** | [![GitHub_Stars](https://img.shields.io/github/stars/kanidm/webauthn-rs?style=social)](https://github.com/kanidm/webauthn-rs/stargazers) | WebAuthn and FIDO2 server library written in Rust for high-security passwordless authentication. | Rust |
| **Janssen Project** | [![GitHub_Stars](https://img.shields.io/github/stars/JanssenProject/jans?style=social)](https://github.com/JanssenProject/jans/stargazers) | Open-source digital identity software platform built for high-scale enterprise authentication and FIDO2. | Python, Java |
| **WebAuthn4j** | [![GitHub_Stars](https://img.shields.io/github/stars/webauthn4j/webauthn4j?style=social)](https://github.com/webauthn4j/webauthn4j/stargazers) | Portable Java library for WebAuthn and FIDO2 server-side attestation and assertion verification. | Java |
| **Hanko Passkey Server** | [![GitHub_Stars](https://img.shields.io/github/stars/teamhanko/passkeys?style=social)](https://github.com/teamhanko/passkeys/stargazers) | Dedicated FIDO2-certified passkey server component for adding passkey authentication to existing backends. | Go |
